 ...
 *
 */
public class ArangoDriverGraphVerticesTest extends BaseGraphTest {

	public ArangoDriverGraphVerticesTest(ArangoConfigure configure, ArangoDriver driver) {
	...
	public void test_vertices_count() throws ArangoException {
		...
		CursorResultSet<DocumentEntity<TestComplexEntity01>> rs = driver.getVerticesWithResultSet("g1", TestComplexEntity01.class, null, null, true, null, null);
	...
	public void test_vertices_batch() throws ArangoException {
		...
		Integer limit = null;
		Boolean count = true;
		CursorEntity<DocumentEntity<TestComplexEntity01>> cursor = driver.getVertices("g1", TestComplexEntity01.class, batchSize, limit, count, null, null);
	...
	public void test_vertices_many_roundtrip_resultset() throws ArangoException {
		...
		Integer limit = null;
		Boolean count = true;
		CursorResultSet<DocumentEntity<TestComplexEntity01>> rs = driver.getVerticesWithResultSet("g1", TestComplexEntity01.class, batchSize, limit, count, null, null);
	...
	public void test_vertices_filter_properties1() throws ArangoException {
		...
		CursorEntity<DocumentEntity<TestComplexEntity01>> cursor = driver.getVertices("g1", TestComplexEntity01.class, batchSize, limit, count, 
				null, null, new FilterCondition("age", 5, "=="));
		assertThat(cursor.getCount(), is(10));
	...
	public void test_vertices_filter_properties2() throws ArangoException {
		...
		Boolean count = true;
		CursorEntity<DocumentEntity<TestComplexEntity01>> cursor = driver.getVertices("g1", TestComplexEntity01.class, batchSize, limit, count, 
				null, null, new FilterCondition("age", 5, ">"), new FilterCondition("desc", "desc3", "=="));
